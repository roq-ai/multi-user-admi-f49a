...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'service.update': {
    ...
    key: 'employee-updates-service',
    tenantPath: ['organization', 'user', 'service'],
    userPath: [],
  },
  'invoice.create': {
    roles: ['admin', 'employee'],
    key: 'service-provider-creates-invoice',
    tenantPath: ['organization', 'user', 'invoice'],
    userPath: [],
  },
  'service.create': {
    roles: ['admin', 'employee', 'team-member', 'service-provider'],
    key: 'customer-requests-service',
    tenantPath: ['organization', 'user', 'service'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin', 'employee', 'team-member', 'service-provider'];

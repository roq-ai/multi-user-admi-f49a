...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{` multi user admin portal `}</title>

        <meta
          name="description"
          content="Experience seamless management with Multi User Admin Portal - Your all-in-one solution for data management, service requests, client invoicing, and team collaboration."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1557754897-ca12c5049d83?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhZG1pbiUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjk0NTE0NDE2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless management with Multi User Admin Portal - Your all-in-one solution for data management, service requests, client invoicing, and team collaboration.`}
            </Text>
            <Box
